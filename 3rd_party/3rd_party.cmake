...
if ("${HOST_SYSTEM_NAME}" STREQUAL "darwin")
  ...
  set(TORCVISION_LIBRARIES "torchvision")
  set(TORCHVISION_LOCATION "/usr/local/lib")
...
elseif ("${HOST_SYSTEM_NAME}" STREQUAL "linux")
  if(NOT DEFINED ENV{CPP_CROSS_COMPILE} OR "$ENV{CPP_CROSS_COMPILE}" STREQUAL "")
    ...
    set(TORCVISION_LIBRARIES "libtorchvision")
    set(TORCHVISION_LOCATION "/usr/local/gcc103/lib")    
  ...
  elseif("$ENV{CPP_CROSS_COMPILE}" STREQUAL "macosx")
    ...
    set(TORCVISION_LIBRARIES "libtorchvision")    
    set(TORCHVISION_LOCATION "${SYSROOT}/usr/local/lib")
    set(TORCH_EXTENSION ".dylib")
  else()
    ...
    set(TORCVISION_LIBRARIES "libtorchvision")   
    set(TORCHVISION_LOCATION "${SYSROOT}/usr/local/gcc103/lib")    
    set(TORCH_EXTENSION ".so")
  endif()
else()
  ...
  set(TORCHVISION_LOCATION "${LOCAL_DRIVE}/usr/local/bin")  
...
install_libs("TorchVision libraries" ${TORCHVISION_LOCATION} "" "${TORCH_EXTENSION}" "${TORCHVISION_LIBRARIES}")
